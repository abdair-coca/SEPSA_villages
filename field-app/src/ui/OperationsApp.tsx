...
function OrderCreationModal({ dialog, debtors, technicians, selectedTechnician, busy, onTechnicianChange, onCancel, onConfirm }: { dialog: OrderCreationDialog; debtors: DebtorRecord[]; technicians: readonly TechnicianRecord[]; selectedTechnician: string; busy: boolean; onTechnicianChange: (technicianId: string) => void; onCancel: () => void; onConfirm: () => void }) {
